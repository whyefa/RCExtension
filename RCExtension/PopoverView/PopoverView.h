...
// 菜单边界样式
typedef NS_ENUM(NSUInteger, PopoverViewBorderStyle) {
    PopoverViewBorderStyleDark = 0, // 半透明背景
    PopoverViewBorderStyleBoarder,  // 边界
    PopoverViewBorderStyleShadow    // 边框阴影
};
 ...
 */
@property (nonatomic, assign) PopoverViewBorderStyle borderStyle;
